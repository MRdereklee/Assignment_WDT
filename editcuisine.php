...
<head>
  ...
  <title>Update Cusine -- Food.INC</title>
...
<body id="page-top">
  ...
  $id = intval($_GET['id']);
  $result = mysqli_query($con, "SELECT * FROM cuisine_table WHERE cuisine_id = $id");
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <form action="php/update_cuisine.php" method="post" enctype="multipart/form-data">
                <p>Cuisine Name:</p>
                <input class="card col-sm-12 form-control " type="text" name="cuisine_name" required="required" value='<?php echo $row['cuisine_type'] ?>'><br>
                <p>Cuisine Description:</p>
                <textarea class="card col-sm-12 form-control" name="cuisine_description" required="required" style="height:100px;"><?php echo $row['cuisine_description'] ?></textarea><br>
                <button type="submit" class="btn_submit">Update</button>
                <button type="reset" class="btn_submit">Reset</button>
                <input type="hidden" name="id" value="<?php echo $row['cuisine_id'] ?>">
              </form>
            </div>
          </div>
