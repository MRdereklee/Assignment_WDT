...
<body>
  ...
  $cuisine_type = mysqli_real_escape_string($con,$_POST['cuisine_type']);
   ?>
  <!--==========================
  Header
  ============================-->
        ...
        <section id="menu" class="">
          <div class="container">
            ...
            <div class="row">
              ...
              $result = mysqli_query($con, "SELECT * FROM item_table WHERE cuisine_id = ".$cuisine_type." ORDER BY item_name ASC");
              while ($row = mysqli_fetch_array($result))
              //List all product out
              {
              echo "<div class=\"col-md-6 col-lg-4\">";
              echo "<form action=\"php/order.php\" method=\"post\" id=\"my_form\">";
              echo  "<div class=\"box\">";
              echo  "<div class=\"icon\" style=\"background: #fceef3;\"><img src='" . $row['item_picture']. "' alt=\"\" class=\"img-fluid\"></div>";
              echo  "<h4 class=\"title\">". $row['item_name']."</h4>";
              echo  "<p class=\"description\">" .$row['item_description']."</p>";
              echo  "<p class=\"description\">Price: RM". $row['item_price']."</p>";
